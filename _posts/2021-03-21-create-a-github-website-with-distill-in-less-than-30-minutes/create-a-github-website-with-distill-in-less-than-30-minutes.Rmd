...
> Note: This post was originally written by [Andreas Handel](https://www.andreashandel.com) and copied here on March 26, 2021 - see the original post [here](https://www.andreashandel.com/post/distill-github-website/) for a potentially updated version.

<center>
<img src="featured.png" width=100%>
</center>
<span style="font-size:0.8rem;">Photo by [Clovis Cheminot](https://pixabay.com/users/clovis_cheminot-949172/)</span>
...
First, you need to install R and Rstudio and set up a GitHub account. (That does not count toward the 30 minutes of getting the website up and running `r emo::ji('grin')`.)
...
Ok, the 30 minute timer starts now `r emo::ji('grin')`. With the above registration and installation bits out of the way, you can get started with your website. To do so, follow these steps:
...
Since the promise was that we'll get a website going in 30 minutes, we won't do any more styling now `r emo::ji('grin')`. As you start customizing your look more, you might want to start read the section [Creating a Website](https://rstudio.github.io/distill/website.html) section on the distill website.
...
**That's it. Now the hard part starts, creating good content. `r emo::ji('smile')`**
